...
const FeaturedProducts = () => {
  return (
    <div className="h-screen w-full flex justify-center">
      <div className="w-4/5 h-4/5 flex flex-col justify-center items-center gap-20">
        {/* Head text */}
        ...
        <div className="mt-8 w-full flex justify-around">
          <div className="flex justify-center items-center flex-col gap-5 w-1/4 text-center">
