...
const Hero = () => {
  return (
    <div className="h-screen w-full flex justify-center">
      <div className="w-4/5 h-4/5 mt-4 flex flex-col md:flex-row gap-4 font-bold">
        <div
          className="w-full md:w-2/5 h-full flex flex-col gap-[5px] p-6"
          style={{
        ...
        >
          ...
          <h2 className="text-[2.5rem] text-primary-text font-bold uppercase">
            Furniture
          </h2>
        ...
        <div className="w-full md:w-3/5 h-full flex flex-col gap-4">
          <div
            className="w-full h-1/2 flex flex-col gap-[5px] p-6"
            style={{
          ...
          <div className="w-full h-1/2 flex flex-col md:flex-row gap-4">
            <div
              className="w-full md:w-1/2 bg-white flex flex-col gap-[5px] p-6"
              style={{
